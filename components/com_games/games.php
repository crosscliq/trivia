...
$options = array( 'site'=>'site', 'type'=>'components', 'ext'=>'com_games' );

// Require the base controller
Games::load( 'GamesController', 'controller', $options );

// Require specific controller if requested
$controller = JRequest::getWord('controller', JRequest::getVar( 'view' ) );
if (!Games::load( 'GamesController'.$controller, "controllers.$controller", $options ))
    $controller = '';
