<?php
/**
 * @version		$Id: jfirephp.php 1826 2010-01-31 03:47:33Z fxstein $
 * @package		Kunena
...
class plgSystemJFirePHP extends JPlugin
{
	...
	function onAfterInitialise()
	{
		...
		if (intval($phpver[0])==4) {
			require_once(JPATH_PLUGINS . '/system/jfirephp/jfirephp/firephpcore/fb.php4');
		} else {
			require_once(JPATH_PLUGINS . '/system/jfirephp/jfirephp/firephpcore/fb.php');
		}
