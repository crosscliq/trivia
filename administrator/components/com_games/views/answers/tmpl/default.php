	...
	<table class="table table-striped table-bordered" style="clear: both;">
		<thead>
            <tr>
                ...
                <th style="width: 50px;">
                	<?php echo DSCGrid::sort( 'ID', "tbl.answer_id", @$state->direction, @$state->order ); ?>
                </th>
                <th style="text-align: left;">
                	<?php echo DSCGrid::sort( 'Text', "tbl.answer_text", @$state->direction, @$state->order ); ?>
                </th>
        ...
        <?php foreach (@$items as $item) : ?>
            <tr class='row<?php echo $k; ?>'>
				...
				<td style="text-align: center;">
					<?php echo DSCGrid::checkedout( $item, $i, 'answer_id' ); ?>
				</td>
				<td style="text-align: center;">
					<a href="<?php echo $item->link; ?>">
						<?php echo $item->answer_id; ?>
					</a>
				</td>
