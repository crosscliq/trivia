...
<?php 
echo $this->sliders->startPanel( JText::_( "COM_GAMES_GENERAL_SETTINGS" ), 'general' );
?>
...
<tr>
    <th style="width: 25%;">
        <?php echo JText::_( 'COM_GAMES_SET_DATE_FORMAT' ); ?>
    </th>
    <td>
        <input name="date_format" value="<?php echo $this->row->get('date_format', '%a, %d %b %Y, %I:%M%p'); ?>" type="text" size="40"/>
    </td>
    <td>
        <?php echo JText::_( "COM_GAMES_SET_DATE_FORMAT_TIP" ); ?>
    </td>
</tr>
<tr>
    <th style="width: 25%;">
        <?php echo JText::_( 'COM_GAMES_SHOW_LINKBACK' ); ?>
    </th>
    <td>
...
<tr>
    <th style="width: 25%;">
        <?php echo JText::_( 'COM_GAMES_INCLUDE_SITE_CSS' ); ?>
    </th>
    <td>
