...
<?php 
echo $this->sliders->startPanel( JText::_( "COM_GAMES_ADMIN_TOOLTIPS" ), 'admin_tooltips' );
?>
...
<table class="adminlist">
    <tbody>
        <tr>
            <th style="width: 25%;">
            <?php echo JText::_( 'COM_GAMES_HIDE_DASHBOARD_TOOLTIPS' ); ?>
            </th>
            <td>
        ...
        <tr>
            <th style="width: 25%;">
            <?php echo JText::_( 'COM_GAMES_HIDE_CONFIGURATION_TOOLTIPS' ); ?>
            </th>
            <td>
        ...
        <tr>
            <th style="width: 25%;">
            <?php echo JText::_( 'COM_GAMES_HIDE_TOOLS_TOOLTIPS' ); ?>
            </th>
            <td>
