...
class GamesControllerQuestions extends GamesController 
{
	...
	function _setModelState()
    {
		...
		$state['filter_game_id'] 	= $app->getUserStateFromRequest($ns.'game_id', 'filter_game_id', '', '');
